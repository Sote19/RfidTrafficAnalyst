...
- - - **1.1.1 (Objetivo Operativo)** - Usar Arduino con RFID para leer datos.  
...
- - - **2.2.2 (Objetivo Operativo)** - Mantener copias de seguridad automáticas para prevenir pérdida de información.
